defmodule DmScenicFront.Component.Nav do
  ...
  def init(current_scene, opts) do
    ...
    graph =
      ...
      |> dropdown(
        {[
           {"Sensor", DmScenicFront.Scene.Sensor},
           {"Sensor (spec)", DmScenicFront.Scene.SensorSpec},
           {"Primitives", DmScenicFront.Scene.Primitives},
           {"Components", DmScenicFront.Scene.Components},
           {"Transforms", DmScenicFront.Scene.Transforms}
         ], current_scene},
        id: :nav,
        translate: {70, 15}
      )
