defmodule DmScenicFront.Scene.Primitives do
  @moduledoc """
  Sample scene.
  """
  ...
  alias DmScenicFront.Component.Nav
  alias DmScenicFront.Component.Notes
  ...
  @bird_path :code.priv_dir(:dm_scenic_front)
